...
param.split_data_num=11;
param.file_path_cam1='F:\reid_dataset\multi_shot1\cam_a\';
param.file_path_cam2='F:\reid_dataset\multi_shot1\cam_b\';
...
for split_num_start=11:param.split_data_num
    ...
    person_file_cam2=[];
    for i=3:202
        image_path_a=strcat(param.file_path_cam1,subdir_cam1(i).name,'\');
    ...
    for i=3:202
        image_path_b=strcat(param.file_path_cam2,subdir_cam2(i).name,'\');
