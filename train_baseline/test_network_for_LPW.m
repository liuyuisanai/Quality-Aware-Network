...
%     net.copy_from(strcat(param.save_model_file,num2str(split_index),'/',param.save_model_name,'_',num2str(86000+model_index*2000),'.caffemodel'));
    net.copy_from(param.fintune_model);
    tic;
    fin=fopen(param.result_save_file,'a');
    str=strcat(param.save_model_file,num2str(split_index),'/',param.save_model_name,'_',num2str(86000+model_index*2000),'.caffemodel');
    fprintf(fin,'model:%s\n',str);
