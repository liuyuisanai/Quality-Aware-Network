...
param.train_maxiter=20;
param.data_path='F:\multi_shot\lab_for_paper\generate_data\';
param.traindata_filename='train_data_RoadPedestrianDataset';
param.testdata_filename='test_data_RoadPedestrianDataset';
